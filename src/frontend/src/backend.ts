...
export class Backend implements backendInterface {
    ...
    async getAchievementPower(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getAchievementPower();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async incrementAchievementPower(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.incrementAchievementPower();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
